  ...
  return (
    <section className={cn('relative', className)}>
      <Container className="flex flex-col items-center pt-10 text-center md:pt-16">
        ...
        <h1 className="mt-3 max-w-[1030px] font-display text-[clamp(2.5rem,6vw,4.5rem)] font-normal leading-none tracking-[-0.0556em] text-balance text-foreground">
          {titleLine1}
          <br />
      ...
      <Container className="mt-[112px] grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
        <h2 className="max-w-[538px] font-display text-[clamp(1.75rem,4vw,2.5rem)] font-medium leading-[1.1] text-foreground">
          {leadBefore}
          <br />
          <span className="text-brand">{leadHighlight}</span>
        </h2>
        <p className="max-w-[650px] font-display text-base leading-[1.3] text-body lg:justify-self-end">
          {body}
        </p>
      </Container>
