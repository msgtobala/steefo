  ...
  return (
    <section className={cn('mt-16 md:mt-24', className)}>
      <Container className="flex flex-col items-center text-center">
        ...
        <h2 className="mt-2 max-w-[655px] font-display text-[clamp(2rem,5vw,4.5rem)] font-normal leading-[1.1] tracking-[-0.0556em] text-foreground">
          {titleBefore}
          <br />
          <span className="text-brand">{titleHighlight}</span>
        </h2>
        <p className="mt-5 max-w-[573px] font-display text-base leading-[1.2] text-body md:mt-6">
          {body}
        </p>
        <div
