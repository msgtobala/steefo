...
/**
 * Privacy Policy copy — sourced from
 * https://www.steefo.com/privacy-policy/
 */
export const privacyStrings = {
  eyebrow: 'Legal',
  title: 'Privacy Policy',
  titleLines: ['Privacy', 'Policy'] as const,
  intro:
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          title: 'Definitions',
          lead: 'For the purposes of this Privacy Policy:',
          items: [
            {
              term: 'Account',
              definition:
            ...
            {
              term: 'Company',
              definition: `(referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to ${company.legalName}, 495, Tajpur Road, Sarkhej-Bavla Highway, Changodar, Ahmedabad – 382210.`,
            },
            {
              term: 'Cookies',
              definition:
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Usage Data',
              text: 'collected in connection with your use of the Service.',
            },
          ],
        },
        {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Cookies or Browser Cookies.',
...
export type PrivacyStrings = typeof privacyStrings
