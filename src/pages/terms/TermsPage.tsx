...
import { termsStrings } from '../../resources/terms_strings'
...
function TermsLinkList({ links }: { links: readonly TermsLink[] }) {
  return (
...
function ParagraphBlock({
  ...
  return (
    <div>
      ...
      {links?.length ? <TermsLinkList links={links} /> : null}
    </div>
  )
}

/**
 * Terms and Conditions — elevated legal layout.
 * Content from https://www.steefo.com/terms-and-conditions/
 */
export function TermsPage() {
  const rootRef = usePageRevealRef({ withHero: true })
  const { eyebrow, title, intro, sections } = termsStrings
  ...
  return (
    <div ref={rootRef} className="bg-surface-muted pb-24 md:pb-32">
      <section className="relative isolate mt-10 overflow-hidden bg-black text-white md:mt-16">
        {/* Brand gradient wash — right side */}
        <div
          aria-hidden
        ...
        {/* Circuit mesh — footer pattern, brightened + faded in from the right */}
        <div
          aria-hidden
        ...
        <Container className="relative z-[1] flex min-h-[20rem] flex-col justify-end pb-16 pt-12 md:min-h-[26rem] md:pb-24 md:pt-16 lg:min-h-[30rem]">
          <div className="max-w-[36rem]">
            ...
            <h1
              ...
              data-animate-hero
            >
              <span className="block">Terms and</span>
              <span className="block">Conditions</span>
            </h1>
            <p
              className="mt-6 max-w-[26rem] font-display text-base leading-[1.45] text-white/55 md:mt-8 md:text-lg"
              data-animate-hero
            >
              {intro}
            </p>
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,15rem)_minmax(0,1fr)] lg:gap-16 xl:grid-cols-[minmax(0,17rem)_minmax(0,1fr)]">
          ...
          <aside className="hidden lg:block" data-animate="up">
            <div className="sticky top-32">
              ...
              <nav aria-label="Terms table of contents" className="mt-4 border-l border-border">
                  ...
                  {section.blocks.map((block, index) => {
                    ...
                    return (
                      <ParagraphBlock
                        ...
                        links={
                          'links' in block
                            ? (block.links as readonly TermsLink[] | undefined)
                            : undefined
                        }
                      />
                    )
